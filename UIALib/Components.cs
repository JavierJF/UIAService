...
namespace UIALib
{
    ...
    /// <summary>
    /// Non reactive "Listener Component", that "listen to event" but isn't a source of reactivity.
    /// </summary>
    public class LComponent : Component
    {
        ...
        /// </summary>
        public List<Event> listenedEvents { get; set; }
        /// <summary>
    ...
    // For now, components wont have this property, because it implies that info
    // about the instantiation process is present in the component itself. And that
    // limits the definition of a component.
    // /// <summary>
    // /// List of the components that depends on this one, and which instantiation
    // /// depends on this one.
    // /// </summary>
    // public List<RComponent> innerExpansion { get; set; }
}
